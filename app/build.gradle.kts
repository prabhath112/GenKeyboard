...
configure<ApplicationExtension> {
    ...
    defaultConfig {
        applicationId = "com.genkeyboard.app"
...
fun getGitCommitHash(short: Boolean = false): Provider<String> {
    ...
    val execProvider = providers.exec {
        ...
        isIgnoreExitValue = true // repo may have no commits yet
    }
    return execProvider.standardOutput.asText.map { it.trim().ifBlank { "null" } }
}
